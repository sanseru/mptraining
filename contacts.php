							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<div class="menu">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class="active"><a href="contacts">Contact</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="map">
					...
					src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJfX0ZfPjxaS4RXsk25cBOs6M&key=AIzaSyAMz1yPwRTtoI28rRORfkHvmyCoi0UdwDU" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	<!-- <div class="container">
