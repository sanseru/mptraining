...
$foto=$_FILES['foto']['name'];
   if(strlen($foto)){
      ...
      mysqli_query($koneksi,"update siswa set foto='$foto' where username='$_SESSION[username]'");
    }
...
alert('Data yang anda masukkan belum lengkap !');
    ...
    $a="insert into siswa values('$nip','$nama','$tlahir','$tgllahir','$jk','$agama','$alamat','$nohp','$foto')";
    $x="insert into user values('$nama','$nip','$nipe','$foto','siswa')";
