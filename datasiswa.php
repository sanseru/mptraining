...
<section class="content">
    ...
    <button type="button" onclick="location.href='tambahsiswa.php'" class="btn btn-primary">
...
<tr>
                ...
                <a href="javascript:if(confirm('Anda yakin menghapus ini?'))
                {document.location='tambahsiswa.php?Nis=<?php echo $c['Nis']; ?>';}"><i class="fa fa-edit"></i> tambah</a>
								</td>
